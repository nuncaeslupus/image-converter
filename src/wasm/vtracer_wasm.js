 ...
 * @returns {string}
 */
export function convert_rgba(rgba, width, height, color_mode, hierarchical, mode, filter_speckle, color_precision, layer_difference, corner_threshold, length_threshold, splice_threshold, max_iterations, path_precision) {
    let deferred6_0;
    let deferred6_1;
    try {
        ...
        const ret = wasm.convert_rgba(ptr0, len0, width, height, ptr1, len1, ptr2, len2, ptr3, len3, filter_speckle, color_precision, layer_difference, corner_threshold, length_threshold, splice_threshold, max_iterations, path_precision);
        var ptr5 = ret[0];
        var len5 = ret[1];
        if (ret[3]) {
            ptr5 = 0; len5 = 0;
